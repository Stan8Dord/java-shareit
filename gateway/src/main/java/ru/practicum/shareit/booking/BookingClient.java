...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> replyBooking(int userId, Long bookingId, Boolean approved) {
        Map<String, Object> parameters = Map.of(
                "approved", approved
        );
    ...
    public ResponseEntity<Object> getAllUserStuffBookings(int userId, BookingState state, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
                "from", from,
                "size", size
